...
const offices=[
 {permission:'claims:review',title:'Trust & safety',copy:'Ownership claims, studio verification and marketplace integrity.',icon:ShieldCheck,href:'/registry-admin'},
 {permission:'settlements:review',title:'Finance',copy:'Settlement exceptions, invoices, fee governance and reconciliation.',icon:ReceiptText,href:'/registry-admin'},
 {permission:'support:read',title:'Customer support',copy:'Customer-facing issues and operational service health without private message access.',icon:Headphones,href:'/registry-admin'},
 {permission:'providers:oversight',title:'Provider operations',copy:'Provider onboarding, registrations, verified status and marketplace readiness.',icon:Building2,href:'/registry-admin'},
