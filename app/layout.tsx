...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body data-sessions-brand="v1" data-sessions-release={SESSIONS_RELEASE.id}><ProductionRouteGuard/>{children}<WorkspaceSwitcher/></body></html>}
