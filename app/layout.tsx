...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body data-sessions-brand="v1"><ProductionRouteGuard/>{children}</body></html>}
