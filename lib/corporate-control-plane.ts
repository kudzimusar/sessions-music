...
export const corporateModules:readonly CorporateModule[]=[
 ...
 {id:'bookings',title:'Booking operations',shortTitle:'Bookings',description:'Operational state, ownership, SLA and intervention workflow over the canonical marketplace booking ledger.',href:'/corporate/bookings',requiredPermissions:['bookings:read'],kind:'operations',ownerDepartment:'Marketplace Operations',supportingDepartments:['Customer Support','Trust & Safety','Finance'],mobilePriority:3},
 ...
 {id:'incidents',title:'Incidents & cases',shortTitle:'Cases',description:'Canonical operational cases with category-scoped access, assignment, SLA, notes, evidence and auditable state transitions.',href:'/corporate/incidents',requiredPermissions:['cases:read'],kind:'operations',ownerDepartment:'Marketplace Operations',supportingDepartments:['Trust & Safety','Customer Support','Finance','Provider Operations'],mobilePriority:7},
