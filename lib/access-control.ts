...
export function canReviewRegistry(actor:PrincipalLike){return hasPermission(actor,'claims:review')||hasPermission(actor,'verification:review')||hasPermission(actor,'registry:write')}
...
export function roleLabel(role:PlatformRole){return ({musician:'Customer / musician',provider_owner:'Provider owner',provider_manager:'Provider manager',provider_staff:'Provider staff',support_agent:'Customer support agent',support_manager:'Customer support manager',trust_safety:'Trust & safety',trust_safety_manager:'Trust & safety manager',finance_admin:'Finance administrator',finance_manager:'Finance manager',provider_operations:'Provider operations',provider_operations_manager:'Provider operations manager',growth_analyst:'Growth analyst',growth_manager:'Growth manager',data_analyst:'Data analyst',data_admin:'Data administrator',product_operations:'Product operations',governance_reviewer:'Governance reviewer',operations_admin:'Marketplace operations',corporate_admin:'Corporate administrator',super_admin_eligible:'Super administrator eligible',super_admin:'Legacy super administrator'} as Record<PlatformRole,string>)[role]}
