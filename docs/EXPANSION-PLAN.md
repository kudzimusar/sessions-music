...
The current Sites access check reports public access. Public publication requires explicit approval under the hosting workflow. This patch does not change access or activate payments.
