...
| W4 | Booking proof, inbox and consented reminder contracts | Code-complete and privately deployed | `docs/PHASE-R-W4.md`, 112-test checkpoint, QR/ICS/offline reference, message authorization and idempotent delivery logs; live scheduler activation remains gated |
