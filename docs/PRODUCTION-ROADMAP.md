...
| W3b | 12-session recurring series, membership attendance/settlement ledger and optional loyalty credit | Code-complete; final certification pending | Atomic series, offline membership evidence and default-off studio-specific credit |
